...
def FFT_loss(enhanced_data, gt_data):
        # get fft of both source and target
    fft_src = torch.rfft( enhanced_data.clone(), signal_ndim=2, onesided=False ) 
    fft_trg = torch.rfft( gt_data.clone(), signal_ndim=2, onesided=False )
    ...
    loss_amp = criterion(amp_trg,amp_src)
    loss_pha = criterion(pha_trg,pha_src)

    fft_loss = loss_amp + loss_pha
